...
### Schema mismatch #1
- Field: `serializer_data.serializer_data[0].name`
- Rule: Field 'serializer_data.serializer_data[*].name' must be of type 'string'.
...
### Schema mismatch #4
- Field: `serializer_data.serializer_data[2].actual_price`
- Rule: Field 'serializer_data.serializer_data[*].actual_price' must be of type 'number'.
- Detail: null returned but field is not nullable in spec
...
- [FAIL] `serializer_data.serializer_data[0].name` :: null returned but field is not nullable in spec
- [FAIL] `serializer_data.serializer_data[1].code` :: null returned but field is not nullable in spec
- [FAIL] `serializer_data.serializer_data[1].sell_price` :: null returned but field is not nullable in spec
- [FAIL] `serializer_data.serializer_data[2].actual_price` :: null returned but field is not nullable in spec
...
- [PASS] `serializer_data.serializer_data[0].code` :: pass
- [PASS] `serializer_data.serializer_data[2].code` :: pass
- [PASS] `serializer_data.serializer_data[0].quantity` :: pass
